...
{
    public class ClientAccountService : AccountServiceBase, IAccountService
    {
        public ClientAccountService(IUnitOfWork unitOfWork, IRegisterValidator registerValidator, IEncryptor encryptor, ISession session)
