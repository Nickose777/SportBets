...
{
    public abstract class ClientControllerBase : SubjectBase, ISubject, IClientController
    {
        private readonly FacadeBase<ClientDisplayModel> facade;

        public ClientControllerBase(ServiceFactory factory, FacadeBase<ClientDisplayModel> facade)
            : base(factory)
        {
            this.facade = facade;
        ...
        protected abstract ManageClientsViewModel GetManageClientsViewModel(ISubject subject, FacadeBase<ClientDisplayModel> facade);

        protected abstract ClientInfoViewModel GetClientInfoViewModel(ClientEditModel clientEditModel);
    }
}
